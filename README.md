...
**Driftwood Capital** — fictional independent investment research firm. Their analysts spend half their week reading 10-Ks and 10-Qs before they can produce any original analysis. AI Co-Analyst eats that intake work so they can skip straight to insight.
...
| Hosting            | Railway                                              |
| LLM + embeddings   | Vercel AI Gateway (routing to OpenAI)                |
...
You also need accounts/keys for external services once the app is wired up. Start with [docs/guides/supabase-setup.md](docs/guides/supabase-setup.md) (account + project), then set up a [Vercel AI Gateway](https://vercel.com/docs/integrations/ai-gateway) and provide its configuration and API keys when the LLM layer is wired up.
