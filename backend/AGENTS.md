...
This is the FastAPI service for AI Co-Analyst. Read [../AGENTS.md](../AGENTS.md) first — universal building rules live there. This file adds backend-specific conventions.
...
- OpenAI SDK (pointing to Vercel AI Gateway) for LLM & embeddings
...
- Integration tests go behind `@pytest.mark.integration` and may require live Vercel AI Gateway / Supabase credentials.
